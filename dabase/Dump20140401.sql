...
CREATE TABLE `link` (
  ...
  `longLink` text COLLATE utf8_unicode_ci,
  `linkCode` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `clicks` int(11) DEFAULT NULL,
  `createdDate` datetime DEFAULT NULL,
  `lastAccessed` datetime DEFAULT NULL,
  `description` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`linkId`),
  UNIQUE KEY `linkCode_UNIQUE` (`linkCode`)
...
INSERT INTO `link` VALUES (1,'http://thuc.com.vn','123',4,'0000-00-00 00:00:00','0000-00-00 00:00:00','1');
...
-- Dump completed on 2014-04-01 23:38:08
